...
public class JwtService {
    ...
    public String extractUserPassport(String token) {
    ...
    public boolean isValidToken(String token , UserDetails userDetails){
        final String userPassport = extractUserPassport(token);
        return (userPassport.equals(userDetails.getUsername()))&& !isTokenExpired(token);
    }
